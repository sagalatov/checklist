...
### this, call, apply, bind.  
#### this  
Указывает на тот объект в контексте которого оно было вызвано.
Tекущий контекст выполнения функции. Задается следующими способами:
Функция вызвана через new, this - новый объект 
const bar = new Foo()
Функция вызвана с call, aplly или bind.
